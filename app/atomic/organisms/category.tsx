...
export default function Category ({children}: {
    ...
    return (
        <> 
            <article className="GeistReg flex items-center justify-center mt-6 w-full text-left border-t-2 md:border-none  md:min-w-[450px] md:max-w-[700px] md:h-screen md:overflow-y-auto">
